...
VERTICAL_FARMING = {
    ...
    "turmeric": {
        ...
        "hi": "ऊर्ध्वाधर खेती के लिए सीधे उपयुक्त नहीं, लेकिन लंबवत एकीकृत मूल्य श्रृंखला (खेत से सुखाना, पीसना, ब्रांडेड पैकेजिंग) खेत-गेट राजस्व 3-5 गुना बढ़ाती है।",
    },
    "default": {
        ...
        "hi": "ऊर्ध्वाधर खेती उच्च-मूल्य सब्जियों और ऑफ-सीजन फूलों के लिए सबसे प्रभावशाली। आपकी जैसी फसल के लिए, सर्वोत्तम रणनीति है: ग्रेडिंग, सफाई, पैकेजिंग, और FPO चैनल से सीधी बिक्री।",
    },
}
...
def _generate_narrative(
    ...
    if lang == "hi":
        ...
        return (
            f"आपके {acreage:.1f} एकड़ {crop_name} खेत की अनुमानित सकल आय Rs.{gross_revenue:,.0f} है। "
            f"कुल लागत Rs.{total_cost_val:,.0f} घटाने के बाद अनुमानित शुद्ध लाभ Rs.{net_margin:,.0f} है। "
            f"यदि आप नीचे दिए सभी लागत-बचत सुझाव अपनाएं, तो आप लगभग Rs.{reducible:,.0f} और बचा सकते हैं। "
            f"{risk_line}"
        )
    else:
        risk_line = (
        ...
        return (
            f"Your {acreage:.1f}-acre {crop_name} farm is estimated to generate a gross revenue of "
            f"Rs.{gross_revenue:,.0f}. After total costs of Rs.{total_cost_val:,.0f}, "
            f"your estimated net margin is Rs.{net_margin:,.0f}. "
            f"If you apply all the cost-saving tips below, you could save an additional Rs.{reducible:,.0f}. "
            f"{risk_line}"
        )
...
def run(farm_input: FarmInput) -> RecommendationResult:
    ...
    return RecommendationResult(
        ...
        price_type=crop_data["price_type"],
    )
